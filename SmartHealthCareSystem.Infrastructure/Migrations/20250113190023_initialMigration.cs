        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FK_DoctorId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_Users_FK_DoctorId",
                        column: x => x.FK_DoctorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_Users_FK_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorAvailabilities_Users_FK_DoctorId",
                        column: x => x.FK_DoctorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_FK_DoctorId",
                table: "Appointments",
                column: "FK_DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_FK_PatientId",
                table: "Appointments",
                column: "FK_PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorAvailabilities_FK_DoctorId",
